...
class ValidateCreditCardTransactionCommandExecutorTest {
    ...
    @InjectMocks
    ValidateCreditCardTransactionCommandExecutor validateCreditCardTransactionCommandExecutor;
    ...
    void successIfNoPreviousTransactionFromSender() {
        ...
        validateCreditCardTransactionCommandExecutor.execute(command);
